...
struct ECSWorld final : public ::rust::Opaque {
  ...
  ::rust::Vec<::rust::String> get_components_of_entity(const ::gcs::ffi::EntityId &entity_id) const;
...
::rust::repr::PtrLen gcs$ffi$cxxbridge1$ECSWorld$get_components_of_entity(const ::gcs::ffi::ECSWorld &self, const ::gcs::ffi::EntityId &entity_id, ::rust::Vec<::rust::String> *return$) noexcept;
...
::rust::Vec<::rust::String> ECSWorld::get_components_of_entity(const ::gcs::ffi::EntityId &entity_id) const {
  ::rust::MaybeUninit<::rust::Vec<::rust::String>> return$;
  ::rust::repr::PtrLen error$ = gcs$ffi$cxxbridge1$ECSWorld$get_components_of_entity(*this, entity_id, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
