...
Ref<ComponentInfo>
GCSWorldBase::register_component(const StringName &name, const Ref<ComponentDefinition> &componentDefinition) {
...
Ref<Entity> GCSWorldBase::create_entity() {
...
void GCSWorldBase::register_entity(Ref<Entity> entity) {
...
Ref<ComponentInfo> GCSWorldBase::register_script_component(const StringName &name, Ref<Script> resource) {
...
PoolStringArray GCSWorldBase::get_components_of_entity(Ref<Entity> entity) {
